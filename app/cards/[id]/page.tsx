...
export default async function CardDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main id="main-content" tabIndex={-1} className="page-shell flex-1 space-y-6 py-10"><DemoBanner /><Link href="/" className="underline">Back to dashboards</Link><View dataset={dataset} /></main>
}
