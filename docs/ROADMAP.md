...
**All ten phases completed for v0.1.0 on 2026-09-05.** See [release verification](RELEASE-VERIFICATION.md) for acceptance and publication evidence.
...
| 9 | All | Reproducible self-host packaging/setup/collection commands, deployment docs, verified clean install and version 0.1.0 release artifacts | Complete — `docs/phases/phase-9.md` |
