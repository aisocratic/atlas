...
- Phases 0–6 and 8 have completed implementation and verification evidence in `docs/phases/`.
...
- Phase 7 explicit demo mode and deterministic seeds remains pending. Phase 9 reproducible packaging and v0.1.0 release remains pending.
